            ...
            <div class="m-header">
                <a href="index.html" class="b-brand">
                    ...
                    <img src="{{ asset('dashboard_assets') }}/images/logo-full.png" alt=""
                        class="logo logo-lg" />
                    <img src="{{ asset('dashboard_assets') }}/images/logo-abbr.png" alt=""
                        class="logo logo-sm" />
                </a>
            </div>
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            <div class="mb-4 rounded-3 border">
                                                <img src="{{ asset('dashboard_assets') }}/images/banner/mockup.png"
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{ asset('dashboard_assets') }}/images/general/full-avatar.png"
                                        ...
                                        <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                            <div class="row g-lg-4 nxl-mega-menu-integrations">
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/app-store.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/spotify.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/figma.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/shopify.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/paypal.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/gmail.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/dropbox.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/google-drive.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/github.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/gitlab.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/facebook.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/pinterest.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/instagram.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/twitter.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('dashboard_assets') }}/images/brand/youtube.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{ asset('dashboard_assets') }}/images/banner/1.jpg"
                                                            alt="" class="img-fluid" />
                                                    </div>
                                                    <div class="mt-4">
                                                        <a href="mailto:flexilecode@gmail.com"
                                                    ...
                                                    <div id="carouselResourcesCaptions" class="carousel slide"
                                                        ...
                                                        <div class="carousel-inner rounded-3">
                                                            <div class="carousel-item active">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/banner/6.jpg"
                                                                        alt=""
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/banner/5.jpg"
                                                                        alt=""
                                                                        class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/banner/4.jpg"
                                                                        alt=""
                                                                        class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/banner/3.jpg"
                                                                        alt=""
                                                                        class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/banner/2.jpg"
                                                                        alt=""
                                                                        class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                                        ...
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset('dashboard_assets') }}/images/avatar/1.png"
                                                                                        alt=""
                                                                                        class="img-fluid" />
                                                                                </div>
                                                                                <a href="javascript:void(0);"
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        ...
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset('dashboard_assets') }}/images/avatar/2.png"
                                                                                        alt=""
                                                                                        class="img-fluid" />
                                                                                </div>
                                                                                <a href="javascript:void(0);"
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        ...
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset('dashboard_assets') }}/images/avatar/3.png"
                                                                                        alt=""
                                                                                        class="img-fluid" />
                                                                                </div>
                                                                                <a href="javascript:void(0);"
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        ...
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset('dashboard_assets') }}/images/avatar/4.png"
                                                                                        alt=""
                                                                                        class="img-fluid" />
                                                                                </div>
                                                                                <a href="javascript:void(0);"
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="{{ asset('dashboard_assets') }}/images/avatar/5.png"
                                                    alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                                <a href="javascript:void(0);"
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset('dashboard_assets') }}/images/file-icons/css.png"
                                                    alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                                <a href="javascript:void(0);"
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset('dashboard_assets') }}/images/file-icons/zip.png"
                                                    alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                                <a href="javascript:void(0);"
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset('dashboard_assets') }}/images/file-icons/pdf.png"
                                                    alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                                <a href="javascript:void(0);"
                    ...
                    <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                        <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link"
                            data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <img src="{{ asset('dashboard_assets') }}/vendors/img/flags/4x3/us.svg" alt=""
                            ...
                            <div class="language-items-wrapper">
                                ...
                                <div class="row px-4 pt-3">
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/sa.svg"
                                    ...
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/bd.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Bengali</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/ch.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Chinese</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/nl.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Dutch</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select active">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/us.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>English</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/fr.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>French</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/de.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>German</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/in.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Hindi</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/ru.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Russian</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/es.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Spanish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/tr.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Turkish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img
                                                    src="{{ asset('dashboard_assets') }}/vendors/img/flags/1x1/pk.svg"
                                                    alt="" class="img-fluid" /></div>
                                            <span>Urdo</span>
                                        </a>
                                    </div>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset('dashboard_assets') }}/images/avatar/2.png" alt=""
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset('dashboard_assets') }}/images/avatar/3.png" alt=""
                                    class="rounded me-3 border" />
                                <div class="notifications-desc">
                                    <a href="javascript:void(0);" class="font-body text-truncate-2-line"> <span
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset('dashboard_assets') }}/images/avatar/4.png" alt=""
                                    class="rounded me-3 border" />
                                <div class="notifications-desc">
                                    <a href="javascript:void(0);" class="font-body text-truncate-2-line"> <span
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button"
                            data-bs-auto-close="outside">
                            <img src="{{ asset('dashboard_assets') }}/images/avatar/1.png" alt="user-image"
